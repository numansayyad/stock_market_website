        ...
        <div className="container p-3">
            <div className="row p-5">
                ...
                <div className='text-center'>
                    <a href='' className='mx-2' style={{textDecoration: "none"}}>Explore our products → <i class="fa-solid fa-arrow-right"></i></a>
                    <a href='' className='mx-2' style={{textDecoration: "none"}} >Try Kite demo → <i class="fa-solid fa-arrow-right"></i></a>
